...
Movie::Movie(int id, const std::string &title, const std::string &description,
             ...
             int duration, const std::string &releaseDate, double rating)
    : movieId(id),
      title(title),
      ...
      releaseDate(releaseDate),
      rating(rating) {}
Movie::Movie(const std::string &title, const std::string &description,
             const std::string &genre, const std::string &director, const std::string &cast,
    ...
    : title(title),
      ...
      duration(duration),
      releaseDate(releaseDate) {}
// Các constructor khác nếu cần thiết
Movie::Movie(int id, const std::string &title, const std::string &description,
             const std::string &genre, const std::string &director,
...
void Movie::display() const {
    std::cout << movieId << "\t" << title << "\t" << description << "\t"
              << genre << "\t" << director << "\t" << cast << "\t" << duration
              << " min\t" << releaseDate << "\t" << rating << "/10\n";
}
