...
int main() {
    ...
    std::cout << "Current account: " << currentAccount.getUserName()
              << "\nCurrent Pass Word: " << currentAccount.getPassWord() 
              << "\nCurrent Phone Number: " << currentAccount.getPhoneNumber() << std::endl;
              system("pause");
    return 0;
}
